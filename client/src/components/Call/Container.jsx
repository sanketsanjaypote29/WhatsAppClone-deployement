        ...
        async ({ ZegoExpressEngine }) => {
          ...
          zg.on(
            ...
            async (roomID, updateType, streamList, extendedData) => {
              if (updateType === "ADD") {
                const rmVideo = document.getElementById("remoteVideo");
          ...
          const localVideo = document.getElementById("remoteAudio");
  ...
  return (
    <div className="border-conversation-border border-l w-full bg-conversation-panel-background flex flex-col h-[100vh] overflow-hidden items-center justify-center text-white">
      ...
      <div className="my-5 relative " id="remoteVideo">
        <div className="absolute bottom-5 right-5" id="remoteAudio"></div>
      </div>
